...
const Events = [
    ...
    new Event({
        ...
        description: "High-speed auto racing featuring professional drivers and various car classes.",
    ...
    new Event({
        ...
        description: "Test your film knowledge with a fun movie trivia night at a local pub.",
    ...
    new Event({
        ...
        description: "The culmination of a local soccer league with exciting finals matches.",
